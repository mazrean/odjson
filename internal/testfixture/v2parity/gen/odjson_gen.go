...
func (v *Zoo) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.Slice == nil {
		if m.V2() {
			dst = append(dst, "\",\"slice\":[],\"st"...)
			dst = append(dst, "rings\":"...)
		} else {
			dst = append(dst, "\",\"slice\":null,\""...)
	...
	if v.Map == nil {
		if m.V2() {
			dst = append(dst, "],\"map\":{},\"str_"...)
			dst = append(dst, "map\":"...)
		} else {
			dst = append(dst, "],\"map\":null,\"st"...)
	...
	if v.NestedPtr == nil {
		dst = append(dst, ",\"nested_ptr\":nu"...)
		dst = append(dst, "ll,\"nesteds\":"...)
	} else {
	...
	if v.Nesteds == nil {
		if m.V2() {
			...
			dst = append(dst, "null,\"nested_map"...)
			dst = append(dst, "\":"...)
		}
	} else {
		dst = append(dst, "["...)
	...
	if m.V2() || bool(v.OmitBool) {
		if bool(v.OmitBool) {
			dst = append(dst, ",\"omit_bool\":tru"...)
			dst = append(dst, "e"...)
		} else {
			dst = append(dst, ",\"omit_bool\":fal"...)
			dst = append(dst, "se"...)
		}
	}
	if m.V2() || v.OmitInt != 0 {
