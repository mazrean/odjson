...
func TestParseFloatValue(t *testing.T) {
	for _, tc := range []struct {
		...
		{"1.5", 64, 1.5, true},
		{"-0", 64, 0, true},
		{"-65.613616999999977", 64, -65.613616999999977, true},
		{"43.420273000000009", 32, float64(float32(43.420273000000009)), true},
		{"1e-400", 64, 0, true},
		{"2.2250738585072011e-308", 64, 2.2250738585072011e-308, true},
		{"1e3", 32, 1000, true},
		{"1e400", 64, 0, false},
		{"3.5e38", 32, 0, false},
		{`"1"`, 64, 0, false},
