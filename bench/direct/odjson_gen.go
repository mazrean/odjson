...
//
// Source: odjson -direct -escape-html=false
...
func (v *Book) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.BookIds == nil {
		if m.V2() {
			dst = append(dst, ",\"ids\":[],\"title"...)
			dst = append(dst, "\":\""...)
		} else {
			dst = append(dst, ",\"ids\":null,\"tit"...)
			dst = append(dst, "le\":\""...)
		}
	} else {
		dst = append(dst, ",\"ids\":["...)
	...
	if v.Titles == nil {
		if m.V2() {
			dst = append(dst, "\",\"titles\":[],\"p"...)
			dst = append(dst, "rice\":"...)
		} else {
			dst = append(dst, "\",\"titles\":null,"...)
	...
	if v.Prices == nil {
		if m.V2() {
			dst = append(dst, ",\"prices\":[],\"ho"...)
			dst = append(dst, "t\":"...)
		} else {
			dst = append(dst, ",\"prices\":null,\""...)
			dst = append(dst, "hot\":"...)
		}
	} else {
	...
	if bool(v.Hot) {
		dst = append(dst, "true,\"hots\":"...)
	} else {
		dst = append(dst, "false,\"hots\":"...)
	}
	if v.Hots == nil {
		if m.V2() {
			dst = append(dst, "[],\"author\":{\"na"...)
			dst = append(dst, "me\":\""...)
		} else {
			dst = append(dst, "null,\"author\":{\""...)
			dst = append(dst, "name\":\""...)
		}
	} else {
		dst = append(dst, "["...)
	...
	if bool(v.Author.Male) {
		dst = append(dst, ",\"male\":true},\"a"...)
		dst = append(dst, "uthors\":"...)
	} else {
		dst = append(dst, ",\"male\":false},\""...)
	...
	if v.Authors == nil {
		...
		for i5 := range v.Authors {
			...
			if bool(v.Authors[i5].Male) {
				dst = append(dst, ",\"male\":true}"...)
			} else {
				dst = append(dst, ",\"male\":false}"...)
			}
		}
...
func (v Book) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeBook.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
func MarshalBook(v *Book) ([]byte, error) {
	...
	buf := odjsonrt.GetBuffer()
	var err error
	buf.B, err = v.odjsonAppend(buf.B, odjsonrt.ModeV2)
	if err != nil {
		odjsonrt.PutBuffer(buf)
		return nil, err
	}
...
func AppendBook(dst []byte, v *Book) ([]byte, error) {
	n := len(dst)
	dst, err := v.odjsonAppend(dst, odjsonrt.ModeV2)
	if err != nil {
		return dst[:n], err
	}
	return dst, nil
...
// UnmarshalBook decodes a complete JSON document into v under
...
func (v Author) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeAuthor.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalAuthor decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v TwitterStruct) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeTwitterStruct.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalTwitterStruct decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v *Statuses) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.Coordinates == nil {
		dst = append(dst, "{\"coordinates\":n"...)
		dst = append(dst, "ull,\"favorited\":"...)
	} else {
	...
	if bool(v.Favorited) {
		dst = append(dst, "true,\"truncated\""...)
		dst = append(dst, ":"...)
	} else {
		dst = append(dst, "false,\"truncated"...)
		dst = append(dst, "\":"...)
	}
	if bool(v.Truncated) {
		dst = append(dst, "true,\"created_at"...)
		dst = append(dst, "\":\""...)
	} else {
		dst = append(dst, "false,\"created_a"...)
		dst = append(dst, "t\":\""...)
	}
	...
	if v.Entities.Urls == nil {
		if m.V2() {
			...
			dst = append(dst, "rls\":[],\"hashtag"...)
			dst = append(dst, "s\":"...)
		} else {
			dst = append(dst, "\",\"entities\":{\"u"...)
			dst = append(dst, "rls\":null,\"hasht"...)
			dst = append(dst, "ags\":"...)
		}
	} else {
		dst = append(dst, "\",\"entities\":{\"u"...)
	...
	if v.Entities.Hashtags == nil {
		if m.V2() {
			dst = append(dst, "[],\"user_mention"...)
			dst = append(dst, "s\":"...)
		} else {
			dst = append(dst, "null,\"user_menti"...)
			dst = append(dst, "ons\":"...)
		}
	} else {
		dst = append(dst, "["...)
	...
	if v.Entities.UserMentions == nil {
		if m.V2() {
			dst = append(dst, "[]},\"in_reply_to"...)
			dst = append(dst, "_user_id_str\":"...)
		} else {
			dst = append(dst, "null},\"in_reply_"...)
			dst = append(dst, "to_user_id_str\":"...)
		}
	} else {
		dst = append(dst, "["...)
		...
		dst = append(dst, "]},\"in_reply_to_"...)
		dst = append(dst, "user_id_str\":"...)
	}
	if v.InReplyToUserIDStr == nil {
		dst = append(dst, "null,\"contributo"...)
		dst = append(dst, "rs\":"...)
	} else {
	...
	if v.InReplyToStatusIDStr == nil {
		...
		dst = append(dst, "atus_id_str\":nul"...)
		dst = append(dst, "l,\"id\":"...)
	} else {
		dst = append(dst, ",\"in_reply_to_st"...)
	...
	if v.Geo == nil {
		dst = append(dst, ",\"geo\":null,\"ret"...)
		dst = append(dst, "weeted\":"...)
	} else {
		dst = append(dst, ",\"geo\":"...)
	...
	if bool(v.Retweeted) {
		dst = append(dst, "true,\"in_reply_t"...)
		dst = append(dst, "o_user_id\":"...)
	} else {
		dst = append(dst, "false,\"in_reply_"...)
		dst = append(dst, "to_user_id\":"...)
	}
	if v.InReplyToUserID == nil {
		dst = append(dst, "null,\"place\":"...)
	} else {
...
func (v Statuses) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeStatuses.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalStatuses decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v *Entities) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.Urls == nil {
		if m.V2() {
			dst = append(dst, "{\"urls\":[],\"hash"...)
			dst = append(dst, "tags\":"...)
		} else {
			dst = append(dst, "{\"urls\":null,\"ha"...)
			dst = append(dst, "shtags\":"...)
		}
	} else {
		dst = append(dst, "{\"urls\":["...)
...
func (v Entities) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeEntities.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalEntities decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v Hashtags) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeHashtags.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalHashtags decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v Metadata) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeMetadata.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalMetadata decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v *User) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if bool(v.ProfileBackgroundTile) {
		dst = append(dst, "\",\"profile_backg"...)
		dst = append(dst, "round_tile\":true"...)
		dst = append(dst, ",\"name\":\""...)
	} else {
		dst = append(dst, "\",\"profile_backg"...)
		dst = append(dst, "round_tile\":fals"...)
	...
	if v.FollowRequestSent == nil {
		...
		dst = append(dst, "t_sent\":null,\"pr"...)
		dst = append(dst, "ofile_link_color"...)
		dst = append(dst, "\":\""...)
	} else {
		dst = append(dst, "\",\"follow_reques"...)
	...
	if bool(v.IsTranslator) {
		dst = append(dst, "\",\"is_translator"...)
		dst = append(dst, "\":true,\"id_str\":"...)
		dst = append(dst, "\""...)
	} else {
		dst = append(dst, "\",\"is_translator"...)
		dst = append(dst, "\":false,\"id_str\""...)
		dst = append(dst, ":\""...)
	}
	dst, err = odjsonrt.AppendStringBodyChecked(dst, string(v.IDStr), m)
	if err != nil {
	...
	if bool(v.DefaultProfile) {
		dst = append(dst, "},\"default_profi"...)
		dst = append(dst, "le\":true,\"contri"...)
		dst = append(dst, "butors_enabled\":"...)
	} else {
		dst = append(dst, "},\"default_profi"...)
		dst = append(dst, "le\":false,\"contr"...)
		dst = append(dst, "ibutors_enabled\""...)
		dst = append(dst, ":"...)
	}
	if bool(v.ContributorsEnabled) {
		dst = append(dst, "true,\"favourites"...)
		dst = append(dst, "_count\":"...)
	} else {
		dst = append(dst, "false,\"favourite"...)
		dst = append(dst, "s_count\":"...)
	}
	dst = odjsonrt.AppendInt(dst, int64(v.FavouritesCount))
	if v.URL == nil {
		dst = append(dst, ",\"url\":null,\"pro"...)
		dst = append(dst, "file_image_url_h"...)
		dst = append(dst, "ttps\":\""...)
	} else {
		dst = append(dst, ",\"url\":"...)
	...
	dst = append(dst, ",\"id\":"...)
	dst = odjsonrt.AppendInt(dst, int64(v.ID))
	if bool(v.ProfileUseBackgroundImage) {
		dst = append(dst, ",\"profile_use_ba"...)
		dst = append(dst, "ckground_image\":"...)
		dst = append(dst, "true,\"listed_cou"...)
		dst = append(dst, "nt\":"...)
	} else {
		dst = append(dst, ",\"profile_use_ba"...)
		dst = append(dst, "ckground_image\":"...)
		dst = append(dst, "false,\"listed_co"...)
		dst = append(dst, "unt\":"...)
	}
	...
	if bool(v.Protected) {
		dst = append(dst, ",\"protected\":tru"...)
		dst = append(dst, "e,\"notifications"...)
		dst = append(dst, "\":"...)
	} else {
		dst = append(dst, ",\"protected\":fal"...)
		dst = append(dst, "se,\"notification"...)
		dst = append(dst, "s\":"...)
	}
	if v.Notifications == nil {
		dst = append(dst, "null,\"profile_ba"...)
		dst = append(dst, "ckground_image_u"...)
		dst = append(dst, "rl_https\":\""...)
	} else {
	...
	if bool(v.Verified) {
		dst = append(dst, "\",\"verified\":tru"...)
		dst = append(dst, "e,\"geo_enabled\":"...)
	} else {
		dst = append(dst, "\",\"verified\":fal"...)
		dst = append(dst, "se,\"geo_enabled\""...)
		dst = append(dst, ":"...)
	}
	if bool(v.GeoEnabled) {
		dst = append(dst, "true,\"time_zone\""...)
		dst = append(dst, ":\""...)
	} else {
		dst = append(dst, "false,\"time_zone"...)
		dst = append(dst, "\":\""...)
	}
	...
	if bool(v.DefaultProfileImage) {
		dst = append(dst, "\",\"default_profi"...)
		dst = append(dst, "le_image\":true,\""...)
		dst = append(dst, "profile_backgrou"...)
		dst = append(dst, "nd_image_url\":\""...)
	} else {
		dst = append(dst, "\",\"default_profi"...)
		dst = append(dst, "le_image\":false,"...)
		dst = append(dst, "\"profile_backgro"...)
		dst = append(dst, "und_image_url\":\""...)
	}
	...
	if v.Following == nil {
		dst = append(dst, ",\"following\":nul"...)
		dst = append(dst, "l,\"show_all_inli"...)
		dst = append(dst, "ne_media\":"...)
	} else {
	...
	if bool(v.ShowAllInlineMedia) {
		dst = append(dst, "true,\"screen_nam"...)
		dst = append(dst, "e\":\""...)
	} else {
		dst = append(dst, "false,\"screen_na"...)
		dst = append(dst, "me\":\""...)
	}
...
func (v User) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeUser.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalUser decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v *UserEntities) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.URL.Urls == nil {
		if m.V2() {
			...
			dst = append(dst, "{\"url\":{\"urls\":n"...)
			dst = append(dst, "ull},\"descriptio"...)
			dst = append(dst, "n\":{\"urls\":"...)
		}
	} else {
		dst = append(dst, "{\"url\":{\"urls\":["...)
...
func (v UserEntities) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeUserEntities.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalUserEntities decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v URL) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeURL.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalURL decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v Urls) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeUrls.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalUrls decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v Description) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeDescription.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalDescription decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
...
func (v SearchMetadata) MarshalJSON() ([]byte, error) {
	buf, err := v.odjsonAppend(odjsonSizeSearchMetadata.New(), odjsonrt.ModePlain)
	if err != nil {
		return nil, err
	}
...
// UnmarshalSearchMetadata decodes a complete JSON document into v under
// encoding/json/v2's semantics. Nobody has validated data, so the parser
// rejects what jsontext would have.
