...
func (v *Feature) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.Properties == nil {
		...
		for i1884, k1883 := range keys1882 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k1883, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv1885), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
...
func (v *CitmCatalog) odjsonAppend(dst []byte, m odjsonrt.StringMode) ([]byte, error) {
	...
	if v.AreaNames == nil {
		...
		for i1991, k1990 := range keys1989 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k1990, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv1992), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.AudienceSubCategoryNames == nil {
		...
		for i1995, k1994 := range keys1993 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k1994, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv1996), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.BlockNames == nil {
		...
		for i1999, k1998 := range keys1997 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k1998, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2000), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.Events == nil {
		...
		for i2003, k2002 := range keys2001 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2002, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
	...
	if v.SeatCategoryNames == nil {
		...
		for i2008, k2007 := range keys2006 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2007, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2009), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.SubTopicNames == nil {
		...
		for i2012, k2011 := range keys2010 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2011, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2013), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.SubjectNames == nil {
		...
		for i2016, k2015 := range keys2014 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2015, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2017), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.TopicNames == nil {
		...
		for i2020, k2019 := range keys2018 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2019, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2021), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
	...
	if v.TopicSubTopics == nil {
		...
		for i2024, k2023 := range keys2022 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2023, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
	...
	if v.VenueNames == nil {
		...
		for i2029, k2028 := range keys2027 {
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, k2028, m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"', ':')
			...
			dst = append(dst, '"')
			dst, err = odjsonrt.AppendStringBodyChecked(dst, string(mv2030), m)
			if err != nil {
				return nil, err
			}
			dst = append(dst, '"')
